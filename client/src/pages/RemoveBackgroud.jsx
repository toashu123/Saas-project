    ...
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700">
      ...
      >
        ...
        <input
          ...
          type="file"
          accept="image/*" //it will accept all the image type
        ...
        {
          loading ? <span className="w-4 h-4 border-2 border-t-transparent rounded-full animate-spin"></span> : <Eraser className="w-5"/> 
        }
          Remove Background
